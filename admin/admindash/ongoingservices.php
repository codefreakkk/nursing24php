...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <h2 style="width:75%; margin-top: 5vh; margin-left:5vh;">On Going Services</h2>
    ...
    <script>
        $(document).ready(function() {
            ...
            //  to be worked on this function
            function getOnGoingServices() {
                $.ajax({
                    url: "ajax/getAllOnGoingServices.php",
                    type: "POST",
            ...
            $("#nursename").on("keyup", function() {
                ...
                $.ajax({
                    url: "ajax/getOnGoingServices.php",
                    type: "POST",
                    data: {
                        val: val,
                        city: city
