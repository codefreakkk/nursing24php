...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <h2 style="width:75%; margin-top: 5vh; margin-left:5vh;">Allocate Nurse</h2>
                                ...
                                <div class="row g-0">
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-2">
                                            <button type="button" id="allocateNurse" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#exampleModal" value="'.$row['bid'].'">Allocate Nurse</button>
                                        </div>
                                            </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        function getAvailableNurses() {
            $.ajax({
                url: "ajax/getAvailableNurses.php",
                type: "POST",
                success: function(data) {
                    $("#nurse_cont").html(data);
                }
            })
        }

        $(document).on("click", "#allocate_button", function() {
            let nid = $(this).attr("data-id")
            let bid = $("#bid").val();
            // allocate the nurse and update booking
            $.ajax({
                url: "ajax/setBidNid.php",
                type: "POST",
                data: {
                    nid: nid,
                    bid: bid,
                ...
                success: function(data) {
                    // console.log(data);
                    // getAvailableNurses();
                    location.href="ongoingservices.php"
                }
            })
        })
