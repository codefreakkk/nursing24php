        ...
        if($num == 0) {
            ...
            if(empty($email) || empty($name) || empty($pass1) || empty($pass2)) {
              header('location:signup.php?q=1');
                ...
                if($pass1 == $pass2) {
                  $sql = "INSERT INTO `user` (`uname`, `uemail`, `upass`) VALUES ('$name', '$email', '$pass1')";
                  $result = mysqli_query($con, $sql);
                  if($result) {
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.html">Home</a></span> <span>Sign Up</span></p>
        ...
        <div class="row block-9">
         ...
         <?php
          ...
          if(isset($_GET['q']) == "1") {
            ...
            <strong>Alert !</strong> Error occured please Sign Up Again
          ...
          // if(isset($_GET['q']) == "0") {
          //   echo ' <div class="alert alert-warning alert-dismissible fade show" role="alert">
          //   <strong>Alert !</strong> Password not match
          //   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          // </div>';
          // }
         ...
         ?>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" value="Sign Up" style="border-radius:2px;" class="btn btn-primary mt-3 py-2 px-4">
              </div>
            </form>          
          </div>
        </div>
